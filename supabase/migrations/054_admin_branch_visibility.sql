-- ============================================================================
-- 054 - Branch dropdown: admins see all branches; auto-membership on switch
-- ============================================================================

-- Global admins can access any store; others need profile_stores membership.
...
-- Admins see every active branch. Others see only assigned branches.
...
-- Allow admins to switch into any branch (creates membership if missing).
